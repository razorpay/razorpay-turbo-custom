...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${PODS_ROOT}/razorpay-turbo-custom/Pod/headless/RazorpayTurboUPI.framework"
  install_framework "${PODS_ROOT}/razorpay-turbo-custom/Pod/headless/TurboUpiPlugin.framework"
