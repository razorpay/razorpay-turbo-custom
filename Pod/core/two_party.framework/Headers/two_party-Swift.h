...
SWIFT_ENUM_FWD_DECL(NSInteger, FundSourceType)
@class RZPVPA;
...
SWIFT_ENUM_FWD_DECL(NSInteger, MobileRegistrationFormat)
...
SWIFT_ENUM_FWD_DECL(NSInteger, VpaStatus)
...
SWIFT_ENUM_FWD_DECL(NSInteger, RegisterStatus)
